        ...
        <div className="overflow-y-auto px-6 py-5 space-y-5 text-[13px] text-gray-700 leading-relaxed flex-1">
          ...
          {tab === "ภาพรวม" && (
            <>
              ...
              <FeatureGroup icon="📥" title="นำเข้ารายชื่อ (Import)" color="#185FA5">
                ...
                <Li>เลือกไฟล์จาก Google Drive ได้โดยตรง ไม่ต้องดาวน์โหลดมาไว้ในเครื่องก่อน (ถ้าระบบเปิดใช้งานฟีเจอร์นี้ไว้)</Li>
              ...
              <FeatureGroup icon="📆" title="ปฏิทิน (Calendar)" color="#185FA5">
                <Li>แก้วันเปิด-ปิดภาคเรียนของแต่ละวิชาได้จากหน้านี้โดยตรง — ค่าเดียวกับใน Semester Settings ของวิชานั้น แก้จากที่ไหนก็ได้ ข้อมูลตรงกันเสมอ (ไม่ใช่ค่าคนละชุด)</Li>
                <Li>ปฏิทินแสดงช่วงวันเปิด-ปิดภาคเรียนจริงและ<strong>วันหยุดราชการไทย</strong>พร้อมกันเป็นพื้นฉากหลัง ไม่ต้องเดาหรือเปิดดูแยกที่อื่น</Li>
                <Li>กำหนดช่วง (เลือกจากดรอปดาวน์ สอบกลางภาค/สอบปลายภาค/วันหยุดพิเศษ หรือพิมพ์เองก็ได้) ให้ระบบ<strong>ไม่เปิดคาบอัตโนมัติ</strong>ได้ทั้งจากการพิมพ์วันที่ตรงๆ หรือคลิก 2 ครั้งบนปฏิทิน — ตั้งครั้งเดียวที่เมนู Calendar ใช้ร่วมกันได้ทุกวิชาในบัญชีนี้ ไม่ต้องตั้งซ้ำต่อวิชา</Li>
                <Li>วันหยุดราชการระบบข้าม auto-open ให้เองอยู่แล้วโดยอัตโนมัติ (ไม่ต้องเพิ่มเป็นช่วงไม่เปิดอัตโนมัติซ้ำ) — ที่แสดงบนปฏิทินเป็นแค่ข้อมูลอ้างอิง</Li>
                <Li>มีผลเฉพาะ Auto-Open เท่านั้น — กดเปิดคาบด้วยตนเองในช่วงนั้นยังทำได้ตามปกติ</Li>
                <Li>เพิ่มช่วงไม่เปิดอัตโนมัติแบบเร็วๆ ได้จากหน้า Semester Settings ของแต่ละวิชาเช่นกัน (การ์ด &quot;วันที่ไม่เปิดคาบอัตโนมัติ&quot;) โดยไม่ต้องมาที่เมนู Calendar — ข้อมูลชุดเดียวกัน เห็นตรงกันทั้งสองที่</Li>
              </FeatureGroup>
          ...
          {tab === "คู่มือ" && (
            <>
              <Section title="1. นำเข้ารายชื่อนักศึกษา" color="#185FA5">
                <Step n="1">ที่หน้า Courses กดปุ่ม <Chip>Import</Chip> มุมขวาบน (หรือปุ่มกลางจอถ้ายังไม่มีวิชาเลย) — อัปโหลด .xlsx, .xls, .csv จากเครื่อง หรือกด &quot;เลือกไฟล์จาก Google Drive&quot; ถ้ามี</Step>
              ...
              <Section title="2. เปิดคาบเรียน" color="#185FA5">
                <Step n="1">ที่หน้า Courses กดปุ่ม <Chip>Quick Open</Chip> หรือ <Chip>Open Session</Chip> บนการ์ดวิชาที่ต้องการ</Step>
              ...
              <Section title="8b. แจ้งเตือนอาจารย์ (Notifications)" color="#185FA5">
                ...
                <Step n="4">อีเมล (ทางเลือกเสริม) — กด <Chip>วิธีสมัครและตั้งค่า Resend</Chip> ในการ์ดอีเมลเพื่อดูขั้นตอนสมัครบัญชี Resend ของตัวเองแบบละเอียด แล้ววาง API Key ที่ได้</Step>
                <Note>แนะนำให้ใช้ LINE เป็นหลักเพราะตั้งค่าง่ายกว่า ส่วนอีเมลต้องสมัครบัญชี Resend ของตัวเองก่อน (ฟรี แต่มีขั้นตอนเพิ่ม) — ระบบจะแจ้งเตือนเฉพาะตอนเปิดคาบแบบอัตโนมัติเท่านั้น ไม่แจ้งตอนกดเปิดคาบเอง</Note>
              </Section>

              <Section title="8c. ปฏิทิน — วันเปิด-ปิดภาคเรียน และวันที่ไม่เปิดคาบอัตโนมัติ" color="#185FA5">
                <Step n="1">ไปที่เมนู <Chip>Calendar</Chip></Step>
                <Step n="2">การ์ด &quot;วันเปิด-ปิดภาคเรียน (ต่อวิชา)&quot; — แก้วันที่ตรงนี้ได้เลย กด <Chip>บันทึก</Chip> แล้วค่าจะอัปเดตทั้งที่นี่และหน้า Semester Settings ของวิชานั้น (ข้อมูลชุดเดียวกัน)</Step>
                <Step n="3">การ์ด &quot;วันที่ไม่เปิดคาบอัตโนมัติ&quot; — เลือกช่วงวันที่ได้ 2 แบบ พิมพ์วันเริ่มต้น/วันสิ้นสุดตรงๆ หรือคลิกวันเริ่มต้นแล้วคลิกวันสิ้นสุดบนปฏิทินด้านล่าง (คลิกผิดกด &quot;ล้าง&quot; แล้วเริ่มใหม่ได้) — สองวิธีนี้ผูกกับช่องเดียวกัน</Step>
                <Step n="4">เลือกชื่อช่วงเวลาจากดรอปดาวน์ (สอบกลางภาค/สอบปลายภาค/วันหยุดพิเศษ) หรือเลือก &quot;อื่นๆ&quot; เพื่อพิมพ์เอง แล้วกด <Chip>เพิ่ม</Chip> — มีผลกับ<strong>ทุกวิชา</strong>ในบัญชีนี้ทันที</Step>
                <Step n="5">ปฏิทินด้านล่างจะแรเงาช่วงวันเปิด-ปิดภาคเรียนจริง วันหยุดราชการไทย และช่วงไม่เปิดอัตโนมัติที่ตั้งไว้ ให้เห็นพร้อมกัน</Step>
                <Note>ช่วงไม่เปิดอัตโนมัติมีผลเฉพาะการเปิดคาบ<strong>อัตโนมัติ</strong>เท่านั้น — ถ้าจำเป็นต้องเปิดคาบเองในช่วงนั้น (เช่น สอบซ่อม) ยังกด Open Session ได้ปกติ ลบช่วงวันที่ออกได้ทุกเมื่อที่เมนู Calendar เช่นกัน วันหยุดราชการไม่ต้องเพิ่มเอง ระบบข้ามให้อัตโนมัติอยู่แล้ว หรือจะเพิ่มแบบเร็วๆ จากการ์ด &quot;วันที่ไม่เปิดคาบอัตโนมัติ&quot; ในหน้า Semester Settings ของแต่ละวิชาก็ได้เช่นกัน</Note>
              </Section>
            </>
          )}
          ...
          {tab === "FAQ" && (
            <div className="space-y-3">
              ...
              <FAQ q="ปุ่ม &quot;เลือกไฟล์จาก Google Drive&quot; ไม่ขึ้น หรือกดแล้วไม่มีอะไรเกิดขึ้น?">
                ฟีเจอร์นี้ต้องตั้งค่าเพิ่มที่ระดับระบบ (ไม่ใช่สิ่งที่อาจารย์ตั้งเองได้) — ถ้าปุ่มไม่ขึ้นเลย แปลว่ายังไม่ได้ตั้งค่า
                Google Picker API key ไว้ ให้แจ้งผู้ดูแลระบบ ระหว่างนี้ใช้วิธีอัปโหลดจากเครื่องได้ตามปกติ
              </FAQ>
              ...
              <FAQ q="แจ้งเตือนทางอีเมลใช้ยังไง ทำไมต้องสมัคร Resend เอง?">
                แต่ละอาจารย์ต้องสมัครบัญชี Resend (ผู้ให้บริการส่งอีเมล) ของตัวเองแบบฟรี แล้ววาง API Key ไว้ในระบบ —
                กด <Chip>วิธีสมัครและตั้งค่า Resend</Chip> ในหน้า Notifications เพื่อดูขั้นตอนละเอียด เหตุผลที่ต้องแยก
                บัญชีต่อคน: Resend แบบฟรีไม่ verify domain จะส่งอีเมลได้เฉพาะหาอีเมลเจ้าของบัญชีเท่านั้น ถ้าใช้บัญชีเดียว
                ร่วมกันทุกคนจะส่งหาใครไม่ได้เลยนอกจากเจ้าของบัญชีนั้นคนเดียว — พอแยกบัญชีต่อคน อีเมลที่ได้รับแจ้งเตือน
                ก็คืออีเมลเจ้าของบัญชีนั้นเองพอดี จึงไม่ติดข้อจำกัดนี้ ถ้าไม่อยากตั้งค่าเพิ่มก็ใช้ <strong>LINE</strong> แทนได้
                ซึ่งตั้งค่าง่ายกว่า
              </FAQ>
              ...
              <FAQ q="สัปดาห์สอบกลาง/ปลายภาค ไม่อยากให้ระบบเปิดคาบอัตโนมัติทับ ทำยังไง?">
                ไปที่เมนู <Chip>Calendar</Chip> (หรือการ์ด &quot;วันที่ไม่เปิดคาบอัตโนมัติ&quot; ในหน้า Semester Settings
                ของวิชานั้นก็ได้ ข้อมูลชุดเดียวกัน) แล้วเพิ่มช่วงวันที่สอบไว้ — พิมพ์วันที่เองหรือคลิกบนปฏิทินก็ได้
                ตั้งครั้งเดียว มีผลกับทุกวิชาในบัญชีนี้ — ระบบจะข้าม Auto-Open ให้เองตลอดช่วงนั้น ถ้ามีคาบที่ต้องเปิดจริง
                ในช่วงนั้น (เช่น สอบซ่อม) ยังกด Open Session ด้วยตนเองได้ตามปกติ ไม่ถูกบล็อก
              </FAQ>
              <FAQ q="ปฏิทินในเมนู Calendar แสดงวันหยุดราชการด้วยไหม?">
                แสดงครับ — ปฏิทินหน้านี้แรเงาทั้งช่วงวันเปิด-ปิดภาคเรียน วันหยุดราชการไทย และช่วงไม่เปิดอัตโนมัติที่ตั้งไว้
                พร้อมกันในที่เดียว ไม่ต้องเปิดดูแยกที่อื่น — วันหยุดราชการระบบข้าม Auto-Open ให้เองอยู่แล้วโดยอัตโนมัติ
                ไม่ต้องเพิ่มเป็นช่วงไม่เปิดอัตโนมัติซ้ำอีก
              </FAQ>
