        ...
        <div className="overflow-y-auto px-6 py-5 space-y-5 text-[13px] text-gray-700 leading-relaxed flex-1">
          ...
          {tab === "ภาพรวม" && (
            <>
              ...
              <FeatureGroup icon="📆" title="วันที่ไม่เปิดคาบอัตโนมัติ (Calendar)" color="#185FA5">
                <Li>กำหนดช่วงวันที่ (เช่น สัปดาห์สอบกลางภาค/ปลายภาค) ให้ระบบ<strong>ไม่เปิดคาบอัตโนมัติ</strong>ในช่วงนั้น — ตั้งครั้งเดียวที่เมนู Calendar ใช้ร่วมกันได้ทุกวิชาในบัญชีนี้ ไม่ต้องตั้งซ้ำต่อวิชา</Li>
          ...
          {tab === "คู่มือ" && (
            <>
              ...
              <Section title="8c. วันที่ไม่เปิดคาบอัตโนมัติ (สอบกลาง-ปลายภาค)" color="#185FA5">
                <Step n="1">ไปที่เมนู <Chip>Calendar</Chip></Step>
                <Step n="2">กรอกชื่อช่วงเวลา (เช่น &quot;สอบกลางภาค&quot;) พร้อมวันเริ่มต้น–วันสิ้นสุด แล้วกด <Chip>เพิ่ม</Chip></Step>
                <Step n="3">ช่วงวันที่นี้จะมีผลกับ<strong>ทุกวิชา</strong>ในบัญชีนี้ทันที — ไม่ต้องตั้งซ้ำทีละวิชา</Step>
                <Note>มีผลเฉพาะการเปิดคาบ<strong>อัตโนมัติ</strong>เท่านั้น — ถ้าจำเป็นต้องเปิดคาบเองในช่วงนั้น (เช่น สอบซ่อม) ยังกด Open Session ได้ปกติ ลบช่วงวันที่ออกได้ทุกเมื่อที่เมนู Calendar เช่นกัน</Note>
              </Section>
            </>
          )}
