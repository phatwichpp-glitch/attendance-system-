          ...
          {tab === "ภาพรวม" && (
            <>
              ...
              <FeatureGroup icon="📆" title="ปฏิทิน (Calendar)" color="#185FA5">
                ...
                <Li>ปฏิทินแสดงช่วงวันเปิด-ปิดภาคเรียนจริง (รวมทุกวิชาที่ตั้งค่าไว้) ให้เห็นเป็นพื้นฉากหลัง ไม่ต้องเดาเอง</Li>
                <Li>คลิกวันบนปฏิทิน 2 ครั้ง (วันเริ่ม แล้วก็วันสิ้นสุด) เพื่อกำหนดช่วง (เช่น สัปดาห์สอบกลางภาค/ปลายภาค) ให้ระบบ<strong>ไม่เปิดคาบอัตโนมัติ</strong>ในช่วงนั้น — ตั้งครั้งเดียวที่เมนู Calendar ใช้ร่วมกันได้ทุกวิชาในบัญชีนี้ ไม่ต้องตั้งซ้ำต่อวิชา</Li>
          ...
          {tab === "คู่มือ" && (
            <>
              <Section title="1. นำเข้ารายชื่อนักศึกษา" color="#185FA5">
                <Step n="1">ไปที่เมนู <Chip>Import</Chip> — อัปโหลด .xlsx, .xls, .csv จากเครื่อง หรือกด &quot;เลือกไฟล์จาก Google Drive&quot; ถ้ามี</Step>
              ...
              <Section title="8c. ปฏิทิน — วันเปิด-ปิดภาคเรียน และวันที่ไม่เปิดคาบอัตโนมัติ" color="#185FA5">
                ...
                <Step n="3">ปฏิทินด้านล่างจะแรเงาช่วงวันเปิด-ปิดภาคเรียนจริงให้เห็นตามที่ตั้งไว้</Step>
                <Step n="4">คลิกวันเริ่มต้น แล้วคลิกวันสิ้นสุดบนปฏิทิน เพื่อเลือกช่วงที่ไม่ต้องการให้เปิดคาบอัตโนมัติ (คลิกผิดกด &quot;ล้างการเลือก&quot; แล้วเริ่มใหม่ได้)</Step>
                <Step n="5">กรอกชื่อช่วงเวลา (เช่น &quot;สอบกลางภาค&quot;) แล้วกด <Chip>เพิ่ม</Chip> — มีผลกับ<strong>ทุกวิชา</strong>ในบัญชีนี้ทันที</Step>
                <Note>ช่วงไม่เปิดอัตโนมัติมีผลเฉพาะการเปิดคาบ<strong>อัตโนมัติ</strong>เท่านั้น — ถ้าจำเป็นต้องเปิดคาบเองในช่วงนั้น (เช่น สอบซ่อม) ยังกด Open Session ได้ปกติ ลบช่วงวันที่ออกได้ทุกเมื่อที่เมนู Calendar เช่นกัน</Note>
              </Section>
            </>
          )}
          ...
          {tab === "FAQ" && (
            <div className="space-y-3">
              ...
              <FAQ q="สัปดาห์สอบกลาง/ปลายภาค ไม่อยากให้ระบบเปิดคาบอัตโนมัติทับ ทำยังไง?">
                ไปที่เมนู <Chip>Calendar</Chip> แล้วเพิ่มช่วงวันที่สอบไว้ (ตั้งครั้งเดียว มีผลกับทุกวิชาในบัญชีนี้)
                — ระบบจะข้าม Auto-Open ให้เองตลอดช่วงนั้น ถ้ามีคาบที่ต้องเปิดจริงในช่วงนั้น (เช่น สอบซ่อม) ยังกด
                Open Session ด้วยตนเองได้ตามปกติ ไม่ถูกบล็อก
              </FAQ>
