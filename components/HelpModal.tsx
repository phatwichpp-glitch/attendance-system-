          ...
          {tab === "ภาพรวม" && (
            <>
              ...
              <FeatureGroup icon="🔔" title="เปิดคาบอัตโนมัติ + แจ้งเตือน (Auto-Open)" color="#185FA5">
                ...
                <Li>แจ้งเตือนอาจารย์ทาง Email และ/หรือ LINE ทันทีที่เปิดคาบอัตโนมัติ พร้อม OTP และลิงก์เช็คชื่อ — ตั้งค่าที่เมนู Notifications</Li>
              </FeatureGroup>
          ...
          {tab === "คู่มือ" && (
            <>
              ...
              <Section title="8. เปิดคาบอัตโนมัติ (Auto-Open)" color="#185FA5">
                ...
                <Step n="4">บันทึก — ถึงเวลาตามตารางสอนระบบจะเปิดคาบและออก OTP ให้เอง</Step>
              ...
              <Section title="8b. แจ้งเตือนอาจารย์ (Notifications)" color="#185FA5">
                ...
                <Step n="2">เปิด toggle แจ้งเตือนทางอีเมล — กำหนดอีเมลปลายทางเองได้ ไม่จำเป็นต้องเป็นอีเมลที่ใช้ล็อกอิน</Step>
                <Step n="3">เชื่อมต่อ LINE — กด <Chip>สร้างรหัสเชื่อมต่อ</Chip> เพิ่มเพื่อนบอทของระบบ แล้วส่งรหัสเป็นข้อความหาบอทภายใน 15 นาที</Step>
                <Step n="4">เมื่อเชื่อมสำเร็จ เปิด toggle แจ้งเตือนทาง LINE ได้เลย</Step>
                <Note>เปิดได้ทั้งสองช่องทางพร้อมกันหรือเลือกอันเดียวก็ได้ — ระบบจะแจ้งเตือนเฉพาะตอนเปิดคาบแบบอัตโนมัติเท่านั้น ไม่แจ้งตอนกดเปิดคาบเอง</Note>
              </Section>
            </>
          )}
          ...
          {tab === "FAQ" && (
            <div className="space-y-3">
              ...
              <FAQ q="เปิดคาบอัตโนมัติแล้ว ไม่มีใครอยู่ในห้อง นักศึกษาจะเห็น OTP จากไหน?">
                ...
                หรือให้ระบบแจ้งเตือน OTP มาที่อาจารย์ทาง Email/LINE ตั้งค่าได้ที่เมนู <Chip>Notifications</Chip>
              </FAQ>
              <FAQ q="ทำไมไม่ได้รับแจ้งเตือนตอนเปิดคาบอัตโนมัติ?">
                เช็ค 3 อย่าง: (1) เปิด toggle Email/LINE ไว้ในหน้า Notifications แล้วหรือยัง (2) token ยังไม่หมดอายุ —
              ...
              <FAQ q="ทำไมบัญชีอื่นไม่ได้รับอีเมลแจ้งเตือน ทั้งที่บัญชีแรกได้ปกติ?">
                เป็นข้อจำกัดของ Resend (ผู้ให้บริการส่งอีเมล) — ถ้ายังไม่ได้ verify domain
                จะส่งได้เฉพาะไปยังอีเมลของ<strong>เจ้าของบัญชี Resend</strong> เท่านั้น อาจารย์คนอื่นจะไม่ได้รับ
                แก้ได้ 2 ทาง: (1) verify domain ที่ resend.com/domains แล้วตั้ง NOTIFY_FROM_EMAIL
                เป็นอีเมลบน domain นั้น — ส่งหาใครก็ได้ หรือ (2) ให้อาจารย์ท่านนั้นใช้แจ้งเตือนทาง <strong>LINE</strong> แทน
                ซึ่งไม่มีข้อจำกัดนี้ — กดปุ่ม &quot;ส่งอีเมลทดสอบ&quot; ในหน้า Notifications เพื่อดูสาเหตุที่แท้จริงได้เลย
              </FAQ>
