          ...
          {tab === "คู่มือ" && (
            <>
              ...
              <Section title="8c. ปฏิทิน — วันเปิด-ปิดภาคเรียน และวันที่ไม่เปิดคาบอัตโนมัติ" color="#185FA5">
                ...
                <Step n="3">ปฏิทินด้านล่างจะแรเงาช่วงวันเปิด-ปิดภาคเรียนจริง พร้อมวันหยุดราชการไทย ให้เห็นพร้อมกัน</Step>
                <Step n="4">เลือกช่วงที่ไม่ต้องการให้เปิดคาบอัตโนมัติได้ 2 แบบ — พิมพ์วันเริ่มต้น/วันสิ้นสุดตรงๆ ในช่องด้านล่าง หรือคลิกวันเริ่มต้นแล้วคลิกวันสิ้นสุดบนปฏิทิน (คลิกผิดกด &quot;ล้าง&quot; แล้วเริ่มใหม่ได้) — สองวิธีนี้ผูกกับช่องเดียวกัน</Step>
                <Step n="5">เลือกชื่อช่วงเวลาจากดรอปดาวน์ (สอบกลางภาค/สอบปลายภาค/วันหยุดพิเศษ) หรือเลือก &quot;อื่นๆ&quot; เพื่อพิมพ์เอง แล้วกด <Chip>เพิ่ม</Chip> — มีผลกับ<strong>ทุกวิชา</strong>ในบัญชีนี้ทันที</Step>
