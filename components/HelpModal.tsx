          ...
          {tab === "ภาพรวม" && (
            <>
              ...
              <FeatureGroup icon="🔔" title="เปิดคาบอัตโนมัติ + แจ้งเตือน (Auto-Open)" color="#185FA5">
                ...
                <Li>ต้องปักหมุดตำแหน่ง GPS ห้องเรียนไว้ล่วงหน้า เพราะตอนเปิดคาบอัตโนมัติไม่มีอุปกรณ์อยู่ ณ ที่เกิดเหตุ</Li>
          ...
          {tab === "คู่มือ" && (
            <>
              ...
              <Section title="8. เปิดคาบอัตโนมัติ (Auto-Open)" color="#185FA5">
                <Step n="1">กดเมนู ⋯ บนการ์ดวิชา แล้วเลือก <Chip>Semester Settings</Chip></Step>
                <Step n="2">เปิด toggle <em>เปิดคาบเรียนอัตโนมัติตามตารางสอน</em></Step>
                <Step n="3">ปักหมุดตำแหน่งห้องเรียนบนแผนที่ — ใช้ตรวจ GPS แทนตำแหน่งอุปกรณ์ เพราะไม่มีใครเปิดเครื่อง ณ ตอนนั้น</Step>
